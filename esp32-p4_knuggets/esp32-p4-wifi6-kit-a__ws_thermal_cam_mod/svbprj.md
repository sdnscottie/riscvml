...
**esp32-p4-wifi6-kit-a__ws_thermal_cam_mod** — Dual-camera object detection knugget for the Waveshare ESP32-P4 Wi-Fi 6 Kit A. Combines a MIPI CSI visual camera with the Waveshare Thermal Camera Module (MI0802) for fused visual+thermal ML object detection.
...
| **__free** (student exercise) | Public | https://github.com/sdnscottie/esp32-p4-wifi6-kit-a__ws_thermal_cam_mod__free |
| **__full** (reference solution) | Private | https://github.com/sdnscottie/esp32-p4-wifi6-kit-a__ws_thermal_cam_mod__full |
