# esp32-p4-wifi6-kit-a__servo_driver_direct
...
Companion to:
- `esp32-p4-wifi6-kit-a__servo_driver_PCA9685` (I2C driver, 16-ch)
- `esp32-p4-wifi6-kit-a__motor_driver_IBT2_BTS7960` (DC motor)
