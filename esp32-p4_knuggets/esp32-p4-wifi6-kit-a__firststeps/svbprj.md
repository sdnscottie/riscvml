...
**esp32-p4-wifi6-kit-a__firststeps** — First steps knugget for the Waveshare ESP32-P4 Wi-Fi 6 Kit A development board. Part of the RISCVML educational curriculum (esp32-p4_knuggets).
...
| **__free** (student exercise) | Public | https://github.com/sdnscottie/esp32-p4-wifi6-kit-a__firststeps__free |
| **__full** (reference solution) | Private | https://github.com/sdnscottie/esp32-p4-wifi6-kit-a__firststeps__full |

## Repository Layout: Free/Full Pattern

- `esp32-p4-wifi6-kit-a__firststeps__free/` — **Student exercise** (scaffolded, incomplete)
- `esp32-p4-wifi6-kit-a__firststeps__full/` — **Reference solution** (gold/complete)
