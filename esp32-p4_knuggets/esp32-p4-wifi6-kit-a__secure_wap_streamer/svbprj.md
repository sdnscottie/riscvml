...
**esp32-p4-wifi6-kit-a__secure_wap_streamer** — Secure wireless AP camera streamer knugget for the Waveshare ESP32-P4 Wi-Fi 6 Kit A. The ESP32-P4 acts as a Wi-Fi access point, serving an HTTPS login page and streaming MI0802 thermal camera images to a single authenticated client.
